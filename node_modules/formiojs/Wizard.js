  ...
  _createClass(Wizard, [{
          ...
          if (!isAllowPrevious || index <= _this9.enabledIndex) {
            _this9.addEventListener(link, 'click', function (event) {
              ...
              return _this9.setPage(index).then(function () {
                _this9.emit('wizardPageSelected', _this9.pages[index], index);
              });
            });
          }
        });
    ...
    value: function focusOnComponent(key) {
      ...
      if (page && page !== this.currentPage) {
        return this.setPage(pageIndex).then(function () {
          _this21.checkValidity(_this21.submission.data, true, _this21.submission.data);

          _this21.showErrors();

          _get(_getPrototypeOf(Wizard.prototype), "focusOnComponent", _this21).call(_this21, key);
        });
      }
    ...
    set: function set(value) {
      ...
      _lodash.default.each(this.getPages({
        ...
        component.data = _this22.componentContext(component);
      });
    }
  }, {
    key: "wizardKey",
    ...
    get: function get() {
      ...
      [{
        ...
        if (_this23.hasButton(button.name)) {
