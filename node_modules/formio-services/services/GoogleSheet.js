...
class GoogleSheet {
  ...
  addRow(config, settings, data) {
    if (this.service.active) {
      return this.service.callPromise('POST', '/row', {config, settings, data});
    }
  ...
  updateRow(config, settings, row, data) {
    if (this.service.active) {
      return this.service.callPromise('PUT', `/row/${row}`, {config, settings, data});
    }
  ...
  deleteRow(config, settings, row) {
    if (this.service.active) {
      return this.service.callPromise('DELETE', `/row/${row}`, {config, settings});
    }
